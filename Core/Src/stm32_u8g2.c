...
{
    u8g2_Setup_ssd1306_i2c_128x32_univision_2(u8g2, U8G2_R0, u8x8_byte_hw_i2c1, u8x8_gpio_and_delay); // 初始化u8g2 结构体
...
{
    u8g2_Setup_ssd1306_i2c_128x32_univision_2(u8g2, U8G2_R0, u8x8_byte_hw_i2c2, u8x8_gpio_and_delay); // 初始化u8g2 结构体
    u8g2_InitDisplay(u8g2);                                                                           //
    u8g2_SetPowerSave(u8g2, 0);                                                                       //
    u8g2_ClearBuffer(u8g2);
}
